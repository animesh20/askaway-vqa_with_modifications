...
class Net(nn.Module):
    ...
    def __init__(self, embedding_tokens):
        ...
        self.classifier = Classifier(
            #edit here for including visual features and stacked attention
            #in_features=glimpses * vision_features + question_features,

            #edit here for removing visual features and stacked attention
    ...
    def forward(self, v, q, q_len):
        ...
        #edit here for adding the visual features and stacked attention
        ...
        #edit here for removing the visual features and stacked attention
        answer = self.classifier(q)
        return answer
